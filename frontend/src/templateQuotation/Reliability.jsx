            ...
            <Box >
                ...
                <Box >
                    ...
                    <Grid container justifyContent="center" sx={{ marginTop: '10', paddingBottom: '3' }}>
                        <Typography sx={{ marginTop: '5', paddingBottom: '3', paddingTop: '5' }} variant="h5">Reliability Services Details</Typography>
                        {/* <Grid item xs={12}>
...
export default ReliabilityQuotation;
