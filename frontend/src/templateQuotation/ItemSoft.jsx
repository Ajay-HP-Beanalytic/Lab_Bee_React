...
const ItemSoftQuotation = () => {
    ...
    const setInitialQuotationId = (newCompanyName) => {
        ...
        const dynamicQuotationIdString = `BEA/IT/${newCompanyName}/${currentYear}${currentMonth}${currentDay}-001`;
    ...
    const generateDynamicQuotationIdString = async (newCompanyName) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const dynamicQuotationIdString = `BEA/IT/${newCompanyName}/${currentYear}${currentMonth}${currentDay}-${formattedIncrementedNumber}`;
            ...
            <Box >
                ...
                <Box >
                    ...
                    <Grid container justifyContent="center" sx={{ marginTop: '10', paddingBottom: '3' }}>
                        <Typography sx={{ marginTop: '5', paddingBottom: '3', paddingTop: '5' }} variant="h5">Module Details</Typography>
                        {/* <Grid item xs={12}>
...
export default ItemSoftQuotation;
