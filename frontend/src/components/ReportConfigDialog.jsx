...
const ReportConfigDialog = ({
  ...
  useEffect(() => {
    if (open && initialConfig) {
      ...
      // Set test images - convert base64 array to preview structure
      if (initialConfig.testImagesBase64 && initialConfig.testImagesBase64.length > 0) {
        const testPreviews = initialConfig.testImagesBase64.map((base64, index) => ({
      ...
      if (initialConfig.graphImagesBase64 && initialConfig.graphImagesBase64.length > 0) {
        const graphPreviews = initialConfig.graphImagesBase64.map((base64, index) => ({
